...
DEFAULT_ARKIT_FORWARD_PORT = 17891
...
RAW_FRAME_QUEUE_MAX = 1024
ARP_ROTATION_FILTER_DEADBAND_DEG = 0.08
ARP_ROTATION_FILTER_MIN_ALPHA = 0.12
ARP_ROTATION_FILTER_FAST_ANGLE_DEG = 3.0
VMC_ROTATION_FILTER_DEADBAND_DEG = 0.08
VMC_ROTATION_FILTER_MIN_ALPHA = 0.10
VMC_ROTATION_FILTER_FAST_ANGLE_DEG = 3.0
